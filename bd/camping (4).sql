...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 19 sep. 2024 à 09:20
...
INSERT INTO `animateur` (`numAnimateur`, `nomAnimateur`, `prenomAnimateur`, `paysAnimateur`, `villeAnimateur`, `nomRueAnimateur`, `numRueAnimateur`) VALUES
(1, 'Dupont', 'Jean', 'France', 'Paris', 'Rue de la Paix', '12'),
(2, 'Martin', 'Sophie', 'Belgique', 'Bruxelles', 'Avenue Louise', '34');
...
CREATE TABLE IF NOT EXISTS `animation` (
  ...
  `imageAnimation` varchar(1020) DEFAULT NULL,
...
INSERT INTO `animation` (`idAnimation`, `nomAnimation`, `libelleAnimation`, `imageAnimation`) VALUES
(1, 'Atelier de Peinture', 'Atelier de peinture pour débutants', 'atelier_peinture.jpg'),
(2, 'Tournoi de Volley-ball', 'Tournoi de volley-ball sur la plage', 'tournoi_volley.jpg'),
(3, 'Cours de Yoga', 'Cours de yoga en plein air', 'yoga_plein_air.jpg');
